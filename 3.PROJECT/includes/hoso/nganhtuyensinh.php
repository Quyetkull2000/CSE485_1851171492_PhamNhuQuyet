...
<body>
    ...
    <div class="container" style="margin-top: 40px; ">
        <center><h1 style="color: red;">Ngành xét tuyển</h1></center>
        <div>
            <h4 style="color: red;">Nhóm ngành</h4>
    ...
    <div style="margin-top: 20px;" > 
        <h4 style="color: red;">Tên Ngành</h4>
        <table class="table table-bordered"  border="1">
            <thead >
                <tr style="text-align: center;">
                    <th  class="btn-success ">Mã ngành</th>
                    <th  class="btn-success table-secondary">Tên ngành</th>
                </tr>
            </thead>
            <tbody id="sel_user" style="color: white;">
